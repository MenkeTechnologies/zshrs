...
use super::zsh_lexer::ZshLexer;
use super::zsh_tokens::LexTok;
...
fn simple_name_with_inoutpar(list: &ZshList) -> Option<(Vec<String>, Vec<String>)> {
    ...
    for w in &simple.words[..par_idx] {
        ...
        let bare = super::zsh_lexer::untokenize(w);
    ...
    names.push(super::zsh_lexer::untokenize(bare));
...
impl<'a> ZshParser<'a> {
            ...
            match self.lexer.tok {
                LexTok::String | LexTok::Typeset => {
                    ...
                    if !words.is_empty() && self.lexer.tok.is_redirop() {
                        ...
                        let untoked = super::zsh_lexer::untokenize(last);
    ...
    fn parse_assign(&mut self) -> Option<ZshAssign> {
        use super::zsh_tokens::char_tokens;
                ...
                .unwrap_or(false)
        {
            ...
            let inner = &raw[raw.char_indices().nth(1).map(|(i, _)| i).unwrap_or(0)
                ..raw
                    ...
                    .map(|(i, _)| i)
                    .unwrap_or(raw.len())];
            let cleaned = super::zsh_lexer::untokenize(inner);
