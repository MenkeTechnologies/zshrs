...
#[allow(non_camel_case_types)] pub struct complist;                      // not in zsh.h
...
#[allow(non_camel_case_types)]
pub struct execcmd_params {                                              // c:1492
...
#[allow(non_camel_case_types)]
pub struct feature_enables {                                             // c:1573
...
#[allow(non_camel_case_types)]
pub struct zpc_disables_save {                                           // c:1681
...
#[allow(non_camel_case_types)]
pub struct emulation_options {                                           // c:2570
...
#[inline] #[allow(non_snake_case)] pub fn WCB_END() -> wordcode { wc_bld(WC_END, 0) }                               // c:918
#[inline] #[allow(non_snake_case)] pub fn WC_LIST_TYPE(c: wordcode) -> wordcode { wc_data(c) }                      // c:920
#[inline] #[allow(non_snake_case)] pub fn WC_LIST_SKIP(c: wordcode) -> wordcode { wc_data(c) >> WC_LIST_FREE }      // c:924
#[inline] #[allow(non_snake_case)] pub fn WCB_LIST(t: wordcode, o: wordcode) -> wordcode { wc_bld(WC_LIST, t | (o << WC_LIST_FREE)) }
#[inline] #[allow(non_snake_case)] pub fn WC_SUBLIST_TYPE(c: wordcode) -> wordcode { wc_data(c) & 3 }               // c:927
#[inline] #[allow(non_snake_case)] pub fn WC_SUBLIST_FLAGS(c: wordcode) -> wordcode { wc_data(c) & 0x1c }           // c:931
#[inline] #[allow(non_snake_case)] pub fn WC_SUBLIST_SKIP(c: wordcode) -> wordcode { wc_data(c) >> WC_SUBLIST_FREE }
#[inline] #[allow(non_snake_case)] pub fn WCB_SUBLIST(t: wordcode, f: wordcode, o: wordcode) -> wordcode { wc_bld(WC_SUBLIST, t | f | (o << WC_SUBLIST_FREE)) }
#[inline] #[allow(non_snake_case)] pub fn WC_PIPE_TYPE(c: wordcode) -> wordcode { wc_data(c) & 1 }                  // c:940
#[inline] #[allow(non_snake_case)] pub fn WC_PIPE_LINENO(c: wordcode) -> wordcode { wc_data(c) >> 1 }
#[inline] #[allow(non_snake_case)] pub fn WCB_PIPE(t: wordcode, l: wordcode) -> wordcode { wc_bld(WC_PIPE, t | (l << 1)) }
#[inline] #[allow(non_snake_case)] pub fn WC_REDIR_TYPE(c: wordcode) -> i32 { (wc_data(c) & REDIR_TYPE_MASK as u32) as i32 }
#[inline] #[allow(non_snake_case)] pub fn WC_REDIR_VARID(c: wordcode) -> i32 { (wc_data(c) & REDIR_VARID_MASK as u32) as i32 }
#[inline] #[allow(non_snake_case)] pub fn WC_REDIR_FROM_HEREDOC(c: wordcode) -> i32 { (wc_data(c) & REDIR_FROM_HEREDOC_MASK as u32) as i32 }
#[inline] #[allow(non_snake_case)] pub fn WCB_REDIR(t: wordcode) -> wordcode { wc_bld(WC_REDIR, t) }
#[inline] #[allow(non_snake_case)] pub fn WC_REDIR_WORDS(c: wordcode) -> i32 {
    (if WC_REDIR_VARID(c) != 0 { 4 } else { 3 }) + (if WC_REDIR_FROM_HEREDOC(c) != 0 { 2 } else { 0 })
}
#[inline] #[allow(non_snake_case)] pub fn WC_ASSIGN_TYPE(c: wordcode) -> wordcode { wc_data(c) & 1 }                // c:955
#[inline] #[allow(non_snake_case)] pub fn WC_ASSIGN_TYPE2(c: wordcode) -> wordcode { (wc_data(c) & 2) >> 1 }
#[inline] #[allow(non_snake_case)] pub fn WC_ASSIGN_NUM(c: wordcode) -> wordcode { wc_data(c) >> 2 }
#[inline] #[allow(non_snake_case)] pub fn WCB_ASSIGN(t: wordcode, a: wordcode, n: wordcode) -> wordcode { wc_bld(WC_ASSIGN, t | (a << 1) | (n << 2)) }
#[inline] #[allow(non_snake_case)] pub fn WC_SIMPLE_ARGC(c: wordcode) -> wordcode { wc_data(c) }                    // c:970
#[inline] #[allow(non_snake_case)] pub fn WCB_SIMPLE(n: wordcode) -> wordcode { wc_bld(WC_SIMPLE, n) }
#[inline] #[allow(non_snake_case)] pub fn WC_TYPESET_ARGC(c: wordcode) -> wordcode { wc_data(c) }                   // c:973
#[inline] #[allow(non_snake_case)] pub fn WCB_TYPESET(n: wordcode) -> wordcode { wc_bld(WC_TYPESET, n) }
#[inline] #[allow(non_snake_case)] pub fn WC_SUBSH_SKIP(c: wordcode) -> wordcode { wc_data(c) }                     // c:976
#[inline] #[allow(non_snake_case)] pub fn WCB_SUBSH(o: wordcode) -> wordcode { wc_bld(WC_SUBSH, o) }
#[inline] #[allow(non_snake_case)] pub fn WC_CURSH_SKIP(c: wordcode) -> wordcode { wc_data(c) }                     // c:979
#[inline] #[allow(non_snake_case)] pub fn WCB_CURSH(o: wordcode) -> wordcode { wc_bld(WC_CURSH, o) }
#[inline] #[allow(non_snake_case)] pub fn WC_TIMED_TYPE(c: wordcode) -> wordcode { wc_data(c) }                     // c:982
#[inline] #[allow(non_snake_case)] pub fn WCB_TIMED(t: wordcode) -> wordcode { wc_bld(WC_TIMED, t) }
#[inline] #[allow(non_snake_case)] pub fn WC_FUNCDEF_SKIP(c: wordcode) -> wordcode { wc_data(c) }                   // c:987
#[inline] #[allow(non_snake_case)] pub fn WCB_FUNCDEF(o: wordcode) -> wordcode { wc_bld(WC_FUNCDEF, o) }
#[inline] #[allow(non_snake_case)] pub fn WC_FOR_TYPE(c: wordcode) -> wordcode { wc_data(c) & 3 }                   // c:990
#[inline] #[allow(non_snake_case)] pub fn WC_FOR_SKIP(c: wordcode) -> wordcode { wc_data(c) >> 2 }
#[inline] #[allow(non_snake_case)] pub fn WCB_FOR(t: wordcode, o: wordcode) -> wordcode { wc_bld(WC_FOR, t | (o << 2)) }
#[inline] #[allow(non_snake_case)] pub fn WC_SELECT_TYPE(c: wordcode) -> wordcode { wc_data(c) & 1 }                // c:997
#[inline] #[allow(non_snake_case)] pub fn WC_SELECT_SKIP(c: wordcode) -> wordcode { wc_data(c) >> 1 }
#[inline] #[allow(non_snake_case)] pub fn WCB_SELECT(t: wordcode, o: wordcode) -> wordcode { wc_bld(WC_SELECT, t | (o << 1)) }
#[inline] #[allow(non_snake_case)] pub fn WC_WHILE_TYPE(c: wordcode) -> wordcode { wc_data(c) & 1 }                 // c:1003
#[inline] #[allow(non_snake_case)] pub fn WC_WHILE_SKIP(c: wordcode) -> wordcode { wc_data(c) >> 1 }
#[inline] #[allow(non_snake_case)] pub fn WCB_WHILE(t: wordcode, o: wordcode) -> wordcode { wc_bld(WC_WHILE, t | (o << 1)) }
#[inline] #[allow(non_snake_case)] pub fn WC_REPEAT_SKIP(c: wordcode) -> wordcode { wc_data(c) }                    // c:1009
#[inline] #[allow(non_snake_case)] pub fn WCB_REPEAT(o: wordcode) -> wordcode { wc_bld(WC_REPEAT, o) }
#[inline] #[allow(non_snake_case)] pub fn WC_TRY_SKIP(c: wordcode) -> wordcode { wc_data(c) }                       // c:1012
#[inline] #[allow(non_snake_case)] pub fn WCB_TRY(o: wordcode) -> wordcode { wc_bld(WC_TRY, o) }
#[inline] #[allow(non_snake_case)] pub fn WC_CASE_TYPE(c: wordcode) -> wordcode { wc_data(c) & 7 }                  // c:1015
#[inline] #[allow(non_snake_case)] pub fn WC_CASE_SKIP(c: wordcode) -> wordcode { wc_data(c) >> WC_CASE_FREE }
#[inline] #[allow(non_snake_case)] pub fn WCB_CASE(t: wordcode, o: wordcode) -> wordcode { wc_bld(WC_CASE, t | (o << WC_CASE_FREE)) }
#[inline] #[allow(non_snake_case)] pub fn WC_IF_TYPE(c: wordcode) -> wordcode { wc_data(c) & 3 }                    // c:1024
#[inline] #[allow(non_snake_case)] pub fn WC_IF_SKIP(c: wordcode) -> wordcode { wc_data(c) >> 2 }
#[inline] #[allow(non_snake_case)] pub fn WCB_IF(t: wordcode, o: wordcode) -> wordcode { wc_bld(WC_IF, t | (o << 2)) }
#[inline] #[allow(non_snake_case)] pub fn WC_COND_TYPE(c: wordcode) -> wordcode { wc_data(c) & 127 }                // c:1032
#[inline] #[allow(non_snake_case)] pub fn WC_COND_SKIP(c: wordcode) -> wordcode { wc_data(c) >> 7 }
#[inline] #[allow(non_snake_case)] pub fn WCB_COND(t: wordcode, o: wordcode) -> wordcode { wc_bld(WC_COND, t | (o << 7)) }
#[inline] #[allow(non_snake_case)] pub fn WCB_ARITH() -> wordcode { wc_bld(WC_ARITH, 0) }                           // c:1036
#[inline] #[allow(non_snake_case)] pub fn WCB_AUTOFN() -> wordcode { wc_bld(WC_AUTOFN, 0) }                         // c:1038
...
pub fn EMULATION(emulation: i32, x: i32) -> bool { (emulation & x) != 0 }

/// Port of `#define SHELL_EMULATION()` from `Src/zsh.h:2350`.
#[inline] #[allow(non_snake_case)]
pub fn SHELL_EMULATION(emulation: i32) -> i32 { emulation & ((1 << 5) - 1) }
...
#[inline] #[allow(non_snake_case)]
pub fn ASG_ARRAYP(asg: &asgment) -> bool { (asg.flags & ASG_ARRAY) != 0 }

/// Port of `#define ASG_VALUEP(asg)` from `Src/zsh.h:1296`.
#[inline] #[allow(non_snake_case)]
pub fn ASG_VALUEP(asg: &asgment) -> bool { ASG_ARRAYP(asg) || asg.scalar.is_some() }
...
#[inline] #[allow(non_snake_case)]
pub const fn ZLONG_CONST(x: i64) -> zlong { x }                          // c:68
...
macro_rules! HEAP_ERROR {
    ($heap_id:expr) => {
        eprintln!("{}:{}: HEAP DEBUG: invalid heap: {:x}.",
                  file!(), line!(), $heap_id)
    };
}
...
/// from `Src/zsh.h:1450`.
#[inline] #[allow(non_snake_case)]
pub fn BUILTIN(name: &str, flags: i32, handler: Option<HandlerFunc>,
               min: i32, max: i32, funcid: i32,
               optstr: Option<&str>, defopts: Option<&str>) -> builtin {
    builtin {
        node: hashnode { next: None, nam: name.to_string(), flags },
        handlerfunc: handler,
        minargs: min,
        maxargs: max,
        funcid,
...
pub fn BIN_PREFIX(name: &str, flags: i32) -> builtin {
    BUILTIN(name, flags | BINF_PREFIX as i32, NULLBINCMD, 0, 0, 0, None, None)
}

/// Port of `CONDDEF(name, flags, handler, min, max, condid)` from
/// `Src/zsh.h:701`.
#[inline] #[allow(non_snake_case)]
pub fn CONDDEF(name: &str, flags: i32, handler: CondHandler,
               min: i32, max: i32, condid: i32) -> conddef {
    conddef {
        next: None,
        name: name.to_string(),
        flags,
...
#[inline] #[allow(non_snake_case)]
pub fn NUMMATHFUNC(name: &str, func: NumMathFunc,
                   min: i32, max: i32, id: i32) -> mathfunc {
    mathfunc {
        next: None, name: name.to_string(), flags: 0,
        nfunc: Some(func), sfunc: None, module: None,
        minargs: min, maxargs: max, funcid: id,
    }
}
...
pub fn STRMATHFUNC(name: &str, func: StrMathFunc, id: i32) -> mathfunc {
    mathfunc {
        next: None, name: name.to_string(), flags: MFF_STR,
        nfunc: None, sfunc: Some(func), module: None,
        minargs: 0, maxargs: 0, funcid: id,
    }
}
...
pub fn PARAMDEF(name: &str, flags: i32, var: usize, gsu: usize) -> paramdef {
    paramdef {
        name: name.to_string(), flags, var, gsu,
...
/// `Src/zsh.h:2123`.
#[inline] #[allow(non_snake_case)]
pub fn SPECIALPMDEF(name: &str, flags: i32, gsufn: usize,
                    getfn: Option<GetNodeFunc>,
                    scanfn: Option<ScanTabFunc>) -> paramdef {
    paramdef {
        name: name.to_string(),
...
pub fn WRAPDEF(func: WrapFunc) -> funcwrap {
    funcwrap { next: None, flags: 0, handler: Some(func), module: None }
}
