        ...
        if (shsplit & LEXFLAGS_ACTIVE) != 0 {
            ...
            while p < chars_v.len() {
                ...
                match ch {
                    ...
                    // single span.
                    '#' if cur.is_empty() && (shsplit & LEXFLAGS_COMMENTS_KEEP) != 0 => {
                        cur.push(ch);
                        let mut q = p + 1;
