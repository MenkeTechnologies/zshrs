...
static PARTAB: &[Paramdef] = &[                                              // c:212
    Paramdef { name: "mapfile", registered: false },
];

// `module_features` — port of `static struct features module_features`
// from mapfile.c:267.
static MODULE_FEATURES: Features = Features {                                // c:267
    bn_list: &[],
    cd_list: &[],
    mf_list: &[],
    pd_list: PARTAB,
...
pub fn features_(_m: *const module, features: &mut Vec<String>) -> i32 {     // c:286
    *features = crate::ported::module::featuresarray(                   // c:288
        &module_handle(),
        &MODULE_FEATURES,
    );
    0                                                                    // c:289
...
pub fn enables_(_m: *const module, enables: &mut Option<Vec<i32>>) -> i32 {  // c:294
    crate::ported::module::handlefeatures(&module_handle(), &MODULE_FEATURES, enables) // c:296
}
...
pub fn cleanup_(_m: *const module) -> i32 {                                  // c:308
    crate::ported::module::setfeatureenables(&module_handle(), &MODULE_FEATURES, None) // c:310
}
