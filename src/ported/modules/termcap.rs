...
static BINTAB: &[Builtin] = &[
    Builtin { name: "echotc", flags: 0, minargs: 1, maxargs: -1, funcid: 0, optstr: None, defopts: None },
];

// `partab` — port of `static struct paramdef partab[]` (termcap.c).
static PARTAB: &[Paramdef] = &[
    Paramdef { name: "termcap", registered: false },
];

// `module_features` — port of `static struct features module_features`
// from termcap.c:314.
static MODULE_FEATURES: Features = Features {                                // c:314
    bn_list: BINTAB,
    cd_list: &[],
    mf_list: &[],
    pd_list: PARTAB,
...
pub fn features_(_m: *const module, features: &mut Vec<String>) -> i32 {     // c:330
...
pub fn enables_(_m: *const module, enables: &mut Option<Vec<i32>>) -> i32 {  // c:338
...
pub fn cleanup_(_m: *const module) -> i32 {                                  // c:355
