...
pub const OPTION_DOCS: &[(&str, &str)] = &[
    ...
    ("SH_NULLCMD", "Do not use the values of `NULLCMD` and `READNULLCMD`\nwhen doing redirections, use ``:`' instead (see sectref(Redirection)(zshmisc))."),
