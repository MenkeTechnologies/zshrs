...
use crate::compsys::CompletionGroup;
use crate::compsys::MenuAction;
use crate::compsys::MenuResult;
use crate::compsys::MenuState;
...
impl ZleWidgets {
    ...
    pub fn list_expand(
        ...
        for exp in expansions {
            group.matches.push(crate::compsys::Completion::new(exp));
        }
...
impl ZleCompletionState {
    ...
    pub fn render_menu(&mut self) -> crate::compsys::MenuRendering {
        self.menu.render()
    }
...
mod tests {
    ...
    fn test_find_common_prefix() {
        ...
        g.matches.push(crate::compsys::Completion::new("hello"));
        g.matches.push(crate::compsys::Completion::new("help"));
        g.matches.push(crate::compsys::Completion::new("helicopter"));
    ...
    fn test_menu_complete_cycle() {
        let mut state = ZleCompletionState::new();
        let mut g = CompletionGroup::new("test");
        g.matches.push(crate::compsys::Completion::new("aaa"));
        g.matches.push(crate::compsys::Completion::new("aab"));
        g.matches.push(crate::compsys::Completion::new("aac"));
