...
use crate::compsys::ported::_directory_stack::_directory_stack;
use crate::compsys::ported::_requested::{RequestedAction, _requested};
...
pub fn _tilde(
    ...
    state.tags = crate::compsys::base::TagManager::new();
    state.tags.init(&[
        "users".into(),
