...
const ARCHITECTURES: &[&str] = &[
    "amd64", "evbarm", "evbmips", "evbppc", "hpcarm", "i386", "sparc64", "xen", "acorn32",
    "algor", "alpha", "amiga", "amigappc", "arc", "atari", "bebox", "cats", "cesfic", "cobalt",
    "dreamcast", "emips", "epoc32", "evbsh3", "ews4800mips", "hp300", "hppa", "hpcmips", "hpcsh",
    "ia64", "ibmnws", "iyonix", "landisk", "luna68k", "mac68k", "macppc", "mipsco", "mmeye",
    "mvme68k", "mvmeppc", "netwinder", "news68k", "newsmips", "next68k", "ofppc", "pmax", "prep",
    "rs6000", "sandpoint", "sbmips", "sgimips", "shark", "sparc", "sun2", "sun3", "vax", "x68k",
    "zaurus",
];
