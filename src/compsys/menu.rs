...
use crate::compsys::completion::{Completion, CompletionGroup};
use crate::compsys::zpwr_colors::HeaderColors;
...
impl MenuState {
    pub fn new() -> Self {
        ...
        let config = crate::compsys::zpwr_colors::load_zpwr_config();
    ...
    fn get_item_color(&self, item: &MenuItem, group_color: &str) -> String {
        ...
        if is_file_group || is_dir || is_link || is_exec {
            ...
            let color = crate::compsys::zpwr_colors::ls_color_for_file(display, is_dir, is_exec, is_link);
            if !color.is_empty() {
                return color;
            }
        }
    ...
    fn get_symlink_target_color(&self, path: &str) -> Option<String> {
        ...
        match std::fs::metadata(path) {
            Ok(meta) => {
                ...
                Some(crate::compsys::zpwr_colors::ls_color_for_file(
