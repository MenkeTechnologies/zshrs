...
- **(a) Upstream in fusevm.** Correct long-term — stryke shares fusevm and benefits automatically. Requires fusevm version bump (workspace pins **0.12.1** on crates.io today; see root `Cargo.toml`).
