...
The combination of all six in one shell is what's defended in the patent strategy (`memory/aot_patent_strategy.md`) as three omnibus claims: (1) unified-AOT, (2) daemon architecture, (3) native editor-tooling subsystem (LSP + DAP + plugin-manager-state as IDE library roots).
