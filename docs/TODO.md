...
- **#6 fusevm publish dep** — workspace uses `fusevm = "0.12.1"` (crates.io) in root `Cargo.toml`; path+version dual-publish pattern from older sessions is obsolete unless you reintroduce a path override locally.
