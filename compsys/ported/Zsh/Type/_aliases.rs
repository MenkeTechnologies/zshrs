//! Port of `_aliases` — complete alias names by category.
//!
//! Local shell reference:
//! `/opt/homebrew/share/zsh/functions/_aliases`.
//!
//! Upstream shell source (16 lines):
//! ```text
//!  3  zparseopts -E -D s:=sel
//!  6  [[ -z $sel ]] && sel=rgs
//! 10  [[ $sel = *r* ]] && args+=( 'aliases:regular alias:compadd -k aliases' )
//! 11  [[ $sel = *g* ]] && args+=( 'global-aliases:global alias:compadd -k galiases' )
//! 12  [[ $sel = *s* ]] && args+=( 'suffix-aliases:suffix alias:compadd -k saliases' )
//! 13  [[ $sel = *R* ]] && args+=( 'disabled-aliases:disabled regular alias:compadd -k dis_aliases' )
//! 14  [[ $sel = *G* ]] && args+=( 'disabled-global-aliases:disabled global alias:compadd -k dis_galiases' )
//! 15  [[ $sel = *S* ]] && args+=( 'disabled-suffix-aliases:disabled suffix alias:compadd -k dis_saliases' )
//! 17  _alternative -O opts $args
//! ```
//!
