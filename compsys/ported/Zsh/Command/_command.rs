//! Port of `_command` (zsh Completion/Zsh/Command/_command, 7 lines).
//!
//! Upstream shell source: `/opt/homebrew/share/zsh/functions/_command`
//! (system; vendored tree `compsys/functions/Zsh/Command/_command`
