...
#
# Reduced from upstream Z04zgetopt#1
#   assertion #1: -o or -l required (usage error)
#
# Run it against each shell and diff the two outputs:
#
#   /private/tmp/claude-501/-Users-wizard-RustroverProjects-zshrs/5152e3c4-dbb3-47e6-bcca-262529ff281e/scratchpad/zshsrc/Src/zsh -f tests/ztst_compsys/repros_core/z04zgetopt_001.zsh /private/tmp/claude-501/-Users-wizard-RustroverProjects-zshrs/5152e3c4-dbb3-47e6-bcca-262529ff281e/scratchpad/zshsrc/Src/zsh > /tmp/a.txt 2>&1
#   ZSHRS_NATIVE_ZLE_FX=0 /Users/wizard/RustroverProjects/zshrs/target/debug/zshrs -f tests/ztst_compsys/repros_core/z04zgetopt_001.zsh /Users/wizard/RustroverProjects/zshrs/target/debug/zshrs > /tmp/b.txt 2>&1
#   diff -u /tmp/a.txt /tmp/b.txt
#
# Derived from upstream's own Z04zgetopt.ztst; that file is not modified.  The
...
() { eval '  if ! zmodload -s zsh/zutil; then
