...
#
# Reduced from upstream A01grammar#23
#   assertion #23: rationalisation of arguments to exec -a
#
# Run it against each shell and diff the two outputs:
#
#   /private/tmp/claude-501/-Users-wizard-RustroverProjects-zshrs/5152e3c4-dbb3-47e6-bcca-262529ff281e/scratchpad/zshsrc/Src/zsh -f tests/ztst_compsys/repros_core/a01grammar_023.zsh /private/tmp/claude-501/-Users-wizard-RustroverProjects-zshrs/5152e3c4-dbb3-47e6-bcca-262529ff281e/scratchpad/zshsrc/Src/zsh > /tmp/a.txt 2>&1
#   ZSHRS_NATIVE_ZLE_FX=0 /Users/wizard/RustroverProjects/zshrs/target/debug/zshrs -f tests/ztst_compsys/repros_core/a01grammar_023.zsh /Users/wizard/RustroverProjects/zshrs/target/debug/zshrs > /tmp/b.txt 2>&1
...
() { eval '  touch foo bar' } </dev/null
print -ru2 -- "<<STATUS:$?>>"


() { eval '  (exec -a foo* $ZTST_testdir/../Src/zsh -fc '\''print -r -- ${(V)0}'\'')' } </dev/null
print -ru2 -- "<<STATUS:$?>>"
cd /
rm -rf $work
