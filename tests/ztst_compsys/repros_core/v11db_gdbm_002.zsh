...
#
# Reduced from upstream V11db_gdbm#2
#   assertion #2: create the database
#
# Run it against each shell and diff the two outputs:
#
#   /private/tmp/claude-501/-Users-wizard-RustroverProjects-zshrs/5152e3c4-dbb3-47e6-bcca-262529ff281e/scratchpad/zshsrc/Src/zsh -f tests/ztst_compsys/repros_core/v11db_gdbm_002.zsh /private/tmp/claude-501/-Users-wizard-RustroverProjects-zshrs/5152e3c4-dbb3-47e6-bcca-262529ff281e/scratchpad/zshsrc/Src/zsh > /tmp/a.txt 2>&1
#   ZSHRS_NATIVE_ZLE_FX=0 /Users/wizard/RustroverProjects/zshrs/target/debug/zshrs -f tests/ztst_compsys/repros_core/v11db_gdbm_002.zsh /Users/wizard/RustroverProjects/zshrs/target/debug/zshrs > /tmp/b.txt 2>&1
#   diff -u /tmp/a.txt /tmp/b.txt
#
# Derived from upstream's own V11db_gdbm.ztst; that file is not modified.  The
...
print -ru2 -- "<<STATUS:$?>>"
() { eval ' dbfile=db.gdbm' } </dev/null
print -ru2 -- "<<STATUS:$?>>"
() { eval ' if ! zmodload $modname 2>/dev/null; then
   ZTST_unimplemented="can'\''t load $modname module for testing"
 fi
 rm -f db.gdbm' } </dev/null
print -ru2 -- "<<STATUS:$?>>"


() { eval ' ztie -d db/gdbm -f $dbfile dbase' } </dev/null
print -ru2 -- "<<STATUS:$?>>"
cd /
rm -rf $work
