...
#
# Reduced from upstream X02zlevi#3
#   assertion #3: delete backwards to matching bracket
#
# Run it against each shell and diff the two outputs:
#
#   /private/tmp/claude-501/-Users-wizard-RustroverProjects-zshrs/5152e3c4-dbb3-47e6-bcca-262529ff281e/scratchpad/zshsrc/Src/zsh -f tests/ztst_compsys/repros_core/x02zlevi_003.zsh /private/tmp/claude-501/-Users-wizard-RustroverProjects-zshrs/5152e3c4-dbb3-47e6-bcca-262529ff281e/scratchpad/zshsrc/Src/zsh > /tmp/a.txt 2>&1
#   ZSHRS_NATIVE_ZLE_FX=0 <shell-under-test> -f tests/ztst_compsys/repros_core/x02zlevi_003.zsh <shell-under-test> > /tmp/b.txt 2>&1
#   diff -u /tmp/a.txt /tmp/b.txt
#
# Derived from upstream's own X02zlevi.ztst; that file is not modified.  The
...
() { eval '  if ( zmodload zsh/zpty 2>/dev/null ); then
...
() { eval '  zletest $'\''s( match )\ed%'\''' } </dev/null
print -ru2 -- "<<STATUS:$?>>"
cd /
rm -rf $work
