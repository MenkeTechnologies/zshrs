...
[`examples/demos/*.zsh`](examples/demos/) — 285 self-contained scripts, every
one pinned to the same zshrs binary that runs CI. Eleven batches:
...
cargo test --test examples_demos_ci          # full sweep, ~27s
```
