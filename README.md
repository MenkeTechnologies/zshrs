...
[`examples/demos/*.zsh`](examples/demos/) — 260 self-contained scripts, every
one pinned to the same zshrs binary that runs CI. Ten batches:
...
cargo test --test examples_demos_ci          # full sweep, ~25s
```
