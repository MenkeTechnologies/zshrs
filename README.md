...
[`examples/demos/*.zsh`](examples/demos/) — 335 self-contained scripts, every
one pinned to the same zshrs binary that runs CI. Thirteen batches:
...
cargo test --test examples_demos_ci          # full sweep, ~47s parallel
```
...
```
                  ┌────────────────────────────────────────────────────────────────┐
                  │                       zshrs workspace                          │
                  │             2 crates · 607 .rs files · 611k+ lines             │
                  ├──────────────────────────────────────────┬─────────────────────┤
                  │  src/ (287 .rs — runtime crate)           │  fish/ (157 .rs)    │
                  │  ┌────────────────────────────────────┐   │  reader / line edit │
