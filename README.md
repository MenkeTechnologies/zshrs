...
[`examples/demos/*.zsh`](examples/demos/) — 310 self-contained scripts, every
one pinned to the same zshrs binary that runs CI. Twelve batches:
...
cargo test --test examples_demos_ci          # full sweep, ~34s parallel
```
