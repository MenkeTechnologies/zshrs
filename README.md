...
[`examples/demos/*.zsh`](examples/demos/) — 210 self-contained scripts, every
one pinned to the same zshrs binary that runs CI. Eight batches:
...
cargo test --test examples_demos_ci          # full sweep, ~28s
```
