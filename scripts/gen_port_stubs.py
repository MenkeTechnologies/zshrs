...
# INTENT_MARKERS list removed: any doc-comment-phrase suppression is
# the audit-bypass mechanism described in CLAUDE.md "Audit-Tool
# Tampering". A stub is a stub regardless of how its docstring is
# worded. Structural suppression below (single-call delegation,
# unreachable!/panic!/todo!, iterator-chain idioms) checks actual
# CODE, not free-form doc text — those are safe.
