...
use crate::{
    ...
    common::{get_program_name, PROGRAM_NAME},
    env::{env_init, environment::Environment as _, EnvStack},
    err_fmt, err_str,
    global_safety::RelaxedAtomicBool,
    highlight::{colorize, highlight_shell, HighlightRole, HighlightSpec},
    locale::set_libc_locales,
    operation_context::OperationContext,
    panic::panic_handler,
    parse_constants::{ParseTokenType, ParseTreeFlags, SourceRange},
    parse_util::{apply_indents, compute_indents, SPACES_PER_INDENT},
    prelude::*,
    print_help::print_help,
    threads,
    tokenizer::{TokenType, Tokenizer, TOK_SHOW_BLANK_LINES, TOK_SHOW_COMMENTS},
    topic_monitor::topic_monitor_init,
    wutil::fish_iswalnum,
};
use assert_matches::assert_matches;
use fish_common::{unescape_string, ReadExt as _, UnescapeFlags, UnescapeStringStyle};
use fish_wcstringutil::count_preceding_backslashes;
use fish_wgetopt::{wopt, ArgType, WGetopter, WOption};
use fish_widestring::{bytes2wcstring, osstr2wcstring, wcs2bytes, INTERNAL_SEPARATOR};
use std::{
    ffi::OsStr,
    fmt::Write as _,
    fs,
