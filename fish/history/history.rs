...
use crate::{
    ...
    common::{valid_var_name, CancelChecker},
    env::{EnvMode, EnvSetMode, EnvStack, EnvVar, Environment},
    expand::{expand_one, ExpandFlags},
    fds::wopen_cloexec,
    flog::{flog, flogf},
    fs::{
        fsync, lock_and_load, rewrite_via_temporary_file, LockedFile, LockingMode, PotentialUpdate,
    ...
    prelude::*,
    threads::{assert_is_background_thread, ThreadPool},
    wildcard::wildcard_match,
    wutil::{file_id_for_file, wrealpath, wstat, wunlink, FileId, INVALID_FILE_ID},
};
use bitflags::bitflags;
use fish_common::{unescape_string, UnescapeStringStyle};
use fish_wcstringutil::{subsequence_in_string, trim};
use fish_widestring::{bytes2wcstring, cstr2wcstring, subslice_position, ANY_STRING};
use lru::LruCache;
