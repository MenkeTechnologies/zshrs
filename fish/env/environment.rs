...
use crate::{
    abbrs::{abbrs_get_set, Abbreviation, Position},
    builtins::shared::{BuiltinResult, SUCCESS},
    env::{
        config_paths::{ConfigPaths, PREFIX},
        EnvMode, EnvSetMode, EnvVar, Statuses,
    },
    env_dispatch::{env_dispatch_init, env_dispatch_var_change, VarChangeMilieu},
    event::Event,
    flog::flog,
    global_safety::RelaxedAtomicBool,
    input::{init_input, FISH_BIND_MODE_VAR},
...
use libc::c_int;
use nix::{
    unistd::{gethostname, getpid, Uid, User},
    NixPath as _,
};
use std::{
    collections::HashMap,
