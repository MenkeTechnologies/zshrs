use crate::{
    ...
    localization::{localizable_string, LocalizableString},
...
use fish_common::{escape, unescape_string, ScopeGuard, UnescapeFlags, UnescapeStringStyle};
use fish_util::wcsfilecmp;
use fish_wcstringutil::{
    string_fuzzy_match_string, string_prefixes_string, string_suffixes_string_case_insensitive,
    strip_executable_suffix, StringFuzzyMatch,
};
use fish_widestring::{charptr2wcstring, WExt as _};
use std::{
    cmp::Ordering,
...
mod tests {
    ...
    use crate::{
        abbrs::{self, with_abbrs_mut, Abbreviation},
